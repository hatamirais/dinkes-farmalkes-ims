...
- `mobile`: surface PWA server-rendered untuk penggunaan layar kecil. Versi awal menyediakan pencarian stok, kartu stok mobile, tautan discovery dari aplikasi utama, dan panduan install PWA dengan login/session, CSRF, dan permission Django/module-scope yang sama seperti aplikasi utama.
