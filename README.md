...
- `stock_opname`: proses hitung fisik dan cetak laporan selisih. Dokumen hanya dapat diselesaikan setelah seluruh baris snapshot dihitung, dan sistem menyimpan petugas penyelesai beserta waktu penyelesaiannya.
