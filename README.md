...
- Surface mobile/PWA tersedia di `/mobile/` untuk cek stok serta antrean persetujuan Distribusi dan Kedaluwarsa bagi Kepala/Admin. Surface ini memakai sesi login, CSRF, role gate, dan module scope yang sama dengan aplikasi utama; tindakan persetujuan tetap online-only.
