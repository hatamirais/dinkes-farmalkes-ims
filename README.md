...
- Perlindungan brute-force login menggunakan `django-axes`, dengan lockout berbasis username atau IP sumber agar percobaan terdistribusi terhadap satu akun dan percobaan massal dari satu sumber tetap terblokir.
