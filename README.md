...
- Distribution: `DRAFT/REJECTED -> PREPARED -> SUBMITTED -> VERIFIED -> DISTRIBUTED`. Verifikasi membooking stok pada batch terpilih, reset/step-back/delete/reversal melepas booking tersebut, dan distribusi akhir mengurangi stok fisik sekaligus mengosongkan reservasi. Distribution hasil approval Allocation langsung dibuat pada status `VERIFIED` dengan stok batch terkait sudah dibooking.
