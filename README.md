...
- Surface mobile/PWA awal tersedia di `/mobile/` untuk cek stok berbasis sesi login dan permission yang sama dengan aplikasi utama.
...
- `mobile`: surface PWA server-rendered untuk penggunaan layar kecil. Versi awal menyediakan pencarian stok dan kartu stok mobile dengan login/session, CSRF, dan permission Django/module-scope yang sama seperti aplikasi utama.
